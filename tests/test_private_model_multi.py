...
test_cases = [
    ...
    # Case 1: High Z, but just below safe threshold
    (2000.0, 500.0, 800.0, 600.0, 1500.0, 2500.0, 1000.0, 2000.0, 'Grey Zone'),
    ...
    # Case 4: Borderline Safe/Grey (actually Grey Zone)
    (1500.0, 700.0, 300.0, 200.0, 800.0, 1800.0, 1000.0, 1200.0, 'Grey Zone'),
    # Case 5: Borderline Grey/Distress (actually Distress Zone)
    (1000.0, 800.0, 50.0, 20.0, 100.0, 1200.0, 1100.0, 300.0, 'Distress Zone'),
]
