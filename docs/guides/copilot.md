...
1. **Is it a FINANCIAL INSTITUTION?** → Use Financial Services Model
2. **Is it a RETAILER?** → Use Retail Model
3. **Is it a SERVICE COMPANY?** → Use Service Industry Model
4. **Is it MANUFACTURING?** → Use Original Z-Score
5. **Is it in an EMERGING MARKET?** → Use Emerging Markets Model
6. **Otherwise** → Use Private Company Model
