...
class TrendMetrics:
    ...
    Attributes:
        ...
        r_squared (float): The coefficient of determination for the trend line.
        mean (float): The mean value of the time series.
        std_dev (float): The standard deviation of the time series.
        z_score (float): The calculated Z-Score for the time series.
        periods (int): The number of periods analyzed.
    """
