...
from .plotting_terminal import print_info, print_warning, print_error
...
def plot_zscore_trend(df, ticker, model, out_base, stock_prices=None):
    ...
    if stock_prices is not None and not stock_prices.empty:
        ...
        # Logging of price stats range is intentionally omitted to avoid printing sensitive data
        # If needed for debugging, use logging to a file, not stdout or stderr
